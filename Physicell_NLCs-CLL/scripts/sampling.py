...
def sobol_sampling(nsamples):
    ...
    #Parameters left after exploration
    '''
    default_values = {'secretion_rate_cancer':1.0, 'speed_cancer': 1.0, 'transformation_rate_cancer': 3e-5, 'speed_monocytes': 1.0, 'transformation_rate_monocytes': 95e-6, 
